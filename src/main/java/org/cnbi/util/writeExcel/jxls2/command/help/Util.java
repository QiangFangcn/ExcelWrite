package org.cnbi.util.writeExcel.jxls2.command.help;
...
public class Util {
  ...
  public static Boolean isConditionTrue(ExpressionEvaluator evaluator, Context context) {
    Object conditionResult = evaluator.evaluate(null, context.toMap());
    if (!(conditionResult instanceof Boolean)) {
      throw new EvaluationException(
          "Condition result is not a boolean value - " + evaluator.toString());
    }
    return (Boolean) conditionResult;
  }
