 ...
 * jx:dataHanler2(lastCell="O8" key="t1" items="datas" id="SCODE")
 * @author FangQiang
 */
public class DataHandler extends AbstractCommand{
	
	public final Log logger = LogFactory.getLog(DataHandler.class);
	...
	public DataHandler(String id, String key, String items) {
		super();
		this.id = id;
		this.key = key;
		this.items = items;
